...
const dict = {
  zh: {
    ...
    "dashboard.empty.btn_sample": "生成示例",
    "dashboard.empty.btn_dify": "通过 Dify 生成",
    "dashboard.row.report_id": "报告 #{id}",
    "dashboard.row.all_languages": "全部语言",
    "dashboard.error.title": "无法通过 Dify 生成报告",
    "dashboard.error.tip": "提示：先用",
    "dashboard.error.tip_btn": "「生成示例报告」",
    "dashboard.error.tip_end": "按钮预览整体效果。",
    ...
    "schedule.form.runs_when": "运行时机：打开仪表盘且超过执行时间时自动触发。",
  ...
  en: {
    ...
    "dashboard.btn.sample": "Generate sample",
    ...
    "dashboard.empty.btn_sample": "Generate sample",
    "dashboard.empty.btn_dify": "Generate via Dify",
    ...
    "dashboard.error.tip": "Tip: try the",
    "dashboard.error.tip_btn": "Generate sample",
    "dashboard.error.tip_end": "button to preview the experience.",
    ...
    "schedule.form.runs_when":
      "Runs trigger automatically when the dashboard is opened after the scheduled time.",
